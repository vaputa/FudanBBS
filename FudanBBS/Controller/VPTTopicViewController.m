...
#pragma mark components creation
...
- (NSArray *)rightBarButtonItems {
    ...
    if ([VPTServiceManager isLogin]) {
        ...
        [rightBarButtonItems addObject:[[UIBarButtonItem alloc] initWithCustomView:_btnReply]];
    }
    ...
    [rightBarButtonItems addObjectsFromArray:@[[[UIBarButtonItem alloc] initWithCustomView:_btnQuote],
